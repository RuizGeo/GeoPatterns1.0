...
class kNN:
    ...
    def run(self):
        ...
        #Get plugin path
        self.plugin_path= QgsApplication.qgisSettingsDirPath()+'python/plugins/knn'
        #Try disconnect
        try:
            #disconnect       
    ...
    def run_classification(self):
        ...
        if self.dlg.ui.comboBoxTrain.currentText() == 'None':
            ...
            #Run K-NN
            model_kNN(self.dlg.ui.progressBar,train_path,dataset_path,\
                        validation_path,start_k,end_k,step_k,\
                        field_class_train,\
                        field_class_val,metric_distance,weigth_features,state_applyclass,\
